...
actScheduler.prototype._init = function() {
    this._counter = 0;
    this._mobs = [];
    this._next = false;
...
actScheduler.prototype.getNext = function() {
    this._next = false;
...
actScheduler.prototype._process = function() {
...
actScheduler.prototype._gimmeNrg = function() {
...
actScheduler.prototype.addMob = function(val) {
    this._mobs.push(val);
};

actScheduler.prototype.delMob = function(val) {
    var len = this._mobs.length;
